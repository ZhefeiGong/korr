...
from src.models.residual_dir import ResidualPolicy # NOTE: direct legacy mlp
from src.koopman.ppo_dir.agent import KPMResidualPolicy # NOTE: direct koopman solver
...
class ResidualDiffusionPolicy(DiffusionPolicy):
    ...
    def __init__(
        ...
        self.residual_policy: Union[ResidualPolicy, KPMResidualPolicy] = hydra.utils.instantiate(
            cfg.actor.residual_policy,
            obs_shape=(self.timestep_obs_dim,), # NOTE: 
