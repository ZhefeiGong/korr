...
class DiffusionPolicy(Actor):
    ...
    def __init__(
        ...
        self.inference_steps = actor_cfg.inference_steps # NOTE: the inference steps for DDIM
    ...
    def _normalized_action(self, nobs: torch.Tensor) -> torch.Tensor:
        ...
        # init scheduler
        self.inference_noise_scheduler.set_timesteps(self.inference_steps) # NOTE: set the inference steps for DDIM
